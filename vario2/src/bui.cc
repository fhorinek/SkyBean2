...
uint16_t sound_duration = 0; //1 = 10ms
...
void sound_task()
{
	...
	case (SOUND_OFF):
		...
		buzzer_override_tone = if_in_range(0, 20, 300);
		buzzer_override_tone = if_in_range(40, 60, 600);
		buzzer_override_tone = if_in_range(80, 100, 900);
...
//		{
//			buzzer_override_tone = if_in_range(900, 920, 900);
//			buzzer_override_tone = if_in_range(940, 960, 600);
//			buzzer_override_tone = if_in_range(980, 1000, 300);
//		}
//		else
		{
			buzzer_override_tone = if_in_range(20, 40, 900);
			buzzer_override_tone = if_in_range(60, 80, 600);
			buzzer_override_tone = if_in_range(100, 120, 300);
		}
